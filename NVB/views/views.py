...
import torch
# from NVB.utils import MSelector
from NVB.consts import *
from NVB.dnt import Data, Filter
...
class ParallelCoordinates(View):
    def __init__(self, data, position=[100, 100], size=[1250, 300], highlighter=None, title=None, x_titles=None,
        ...
        """
        super(ParallelCoordinates, self).__init__(data, position, size, highlighter, title=title, border=False)
        selectors = {'default': f"""
    ...
    def core(self):
        super(ParallelCoordinates, self).core()
        View.f.write(f"""
